...
class CianApi:
	...
	def _initialize_driver(self, debug: bool = False) -> webdriver:
	...
	def parse_page(self, url: str) -> dict:
		...
		for ad in main_adverts:
			...
			# getting title
			ad_title_ = div_1.find("div", attrs = {"class": "_93444fe79c--content--lXy9G"}).find("div").find("div").find("div").find("span").find("span").text.strip()
			
			# getting ad link
			ad_link_ = div_1.find("div", attrs = {"class": "_93444fe79c--content--lXy9G"}).find("div").find("div").a["href"]
			
			# Getting price. default price (unhandled) is 0. Running through 4 <div>
			ad_price_ = 0
			for i in range(4):
				try:
					ad_price_ = div_1.find("div", attrs = {"class": "_93444fe79c--content--lXy9G"}).find("div").find("div").find_all("div", attrs={"class": "_93444fe79c--row--kEHOK"})[i].find("div").find("span").text.strip().replace("&nbsp;", "").replace(u'\xa0', u' ')
				except:
					pass
			
			# getting ad adress
			ad_adress_parent_ = div_1.find("div", attrs = {"class": "_93444fe79c--content--lXy9G"}).find('div').find('div').find("div", attrs={"class": "_93444fe79c--labels--L8WyJ"}).find_all("a")
			ad_adress_ = ""
			...
			ad_seller_type_ = div_1.find("div", attrs = {"class": "_93444fe79c--content--lXy9G"}).find("div", attrs={'class': '_93444fe79c--aside--ygGB3'}).find("div", attrs={'class': "_93444fe79c--agent--HG9xn"}).find("div").find("div", attrs={"class": "_93444fe79c--contact--pa2PA"}).find_all("div")[1].find("div").find("div").span.text.strip()

			# getting name of seller
			ad_seller_name_ = div_1.find("div", attrs = {"class": "_93444fe79c--content--lXy9G"}).find("div", attrs={'class': '_93444fe79c--aside--ygGB3'}).find("div", attrs={'class': "_93444fe79c--agent--HG9xn"}).find("div").find("div", attrs={"class": "_93444fe79c--contact--pa2PA"}).find_all("div")[1].find("div").find("div").find("div", attrs={"class": "_93444fe79c--name-container--enElO"}).text.strip()

			# getting link of seller
			try:
				ad_seller_link_ = div_1.find("div", attrs = {"class": "_93444fe79c--content--lXy9G"}).find("div", attrs={'class': '_93444fe79c--aside--ygGB3'}).find("div", attrs={'class': "_93444fe79c--agent--HG9xn"}).find("div").find("div", attrs={"class": "_93444fe79c--contact--pa2PA"}).find_all("div")[1].find("div").find("div").find("div", attrs={"class": "_93444fe79c--name-container--enElO"}).a['href']
			except:
				ad_seller_link_ = "https://www.cian.ru/agents/" + ad_seller_name_.replace("ID ", "")
			
			try:
				# getting array of 5 photos
				ad_photo_links_parent_ = div_1.find("div", attrs={"class": "_93444fe79c--media--9P6wN"}).find("div", attrs={"class": "_93444fe79c--cont--hnKQl"}).find("div", attrs={"class": "_93444fe79c--container--IxdhQ _93444fe79c--container--column--Z9Ik1"}).ul.find_all("li")
				ad_photo_links_ = [p.img['src'] for p in ad_photo_links_parent_]
				if len(ad_photo_links_) >= 5:
					ad_photo_links_ = ad_photo_links_[:5]
			except:
				# empty photo
				ad_photo_links_ = ["https://telegra.ph/file/2f15a97d110e405668b5d.png", "https://telegra.ph/file/2f15a97d110e405668b5d.png"]

			# creating result object
			result_['result'].append(
				{
					"title": ad_title_,
					"link": ad_link_,
					"adress": ad_adress_,
					...
					"seller": 
					{
						"type": ad_seller_type_,
						"link": ad_seller_link_,
